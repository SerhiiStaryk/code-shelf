...
const DesignSystem: React.FC = () => {
  ...
  const typographyExamples = {
    ...
    body1: 'Body 1 - Body Large - This is the default body text style used for most content. It provides good readability and is suitable for paragraphs, descriptions, and general text content.',
    body2: 'Body 2 - Body Medium - This is a smaller body text variant that can be used for secondary information, captions, or when you need more compact text.',
    ...
    <Box>
      ...
      <Alert severity="info" sx={{ mb: 4 }}>
        <Typography variant="body2">
          This design system showcases Material-UI components, typography, colors, and design patterns. 
          Use these components consistently across your application for a cohesive user experience.
        </Typography>
      </Alert>
          ...
          <Card>
            <CardContent>
              ...
              <Stack spacing={2}>
                ...
                <TextField label="Multiline" multiline rows={3} variant="outlined" />
              </Stack>
            </CardContent>
          </Card>
            ...
            <CardContent>
              ...
              <Stack spacing={2}>
                ...
                <Box>
                  ...
                  <Slider value={sliderValue} onChange={(event, newValue) => setSliderValue(newValue as number)} />
                </Box>
        ...
        <Card>
          <CardContent>
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr', lg: 'repeat(4, 1fr)' }, gap: 2 }}>
              ...
              <Paper sx={{ p: 2, textAlign: 'center', backgroundColor: 'secondary.light', color: 'secondary.contrastText' }}>
                xs=12 md=6 lg=3
              </Paper>
        ...
        <Card>
          <CardContent>
            ...
            {stepperActiveStep === steps.length && (
              <Paper square elevation={0} sx={{ p: 3, mt: 3, backgroundColor: 'grey.50' }}>
          ...
          <CardContent>
            ...
            <List>
              ...
              <ListItem>
                ...
                <ListItemText primary="Email" secondary="Check your messages" />
              </ListItem>
              <ListItem>
                <ListItemIcon>
                  <Settings />
                </ListItemIcon>
                <ListItemText primary="Settings" secondary="Configure your preferences" />
              </ListItem>
            </List>
          </CardContent>
        </Card>
