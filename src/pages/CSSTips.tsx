    ...
    <Box>
      ...
      <Alert severity="info" sx={{ mb: 4 }}>
        <Typography variant="body2">
          These CSS tips cover everything from basic layout techniques to advanced performance optimizations. 
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: 3 }}>
          <Card>
            <CardContent>
              ...
              <List dense>
                <ListItem>
                  <ListItemText primary="W3C CSS Validator" secondary="Official CSS validation service" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="CSS Lint" secondary="Code quality tool for CSS" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="Stylelint" secondary="Modern CSS linter" />
                </ListItem>
              </List>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent>
              ...
              <List dense>
                <ListItem>
                  <ListItemText primary="CSS Grid Generator" secondary="Visual grid layout tool" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="Flexbox Froggy" secondary="Learn flexbox interactively" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="CSS Gradient Generator" secondary="Create beautiful gradients" />
                </ListItem>
              </List>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent>
              ...
              <List dense>
                <ListItem>
                  <ListItemText primary="Can I Use" secondary="Browser compatibility tables" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="MDN Web Docs" secondary="Comprehensive CSS documentation" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="CSS-Tricks" secondary="CSS tutorials and examples" />
                </ListItem>
              </List>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent>
              ...
              <List dense>
                <ListItem>
                  <ListItemText primary="Chrome DevTools" secondary="CSS performance profiling" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="Lighthouse" secondary="Performance auditing" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="WebPageTest" secondary="Detailed performance analysis" />
                </ListItem>
              </List>
            </CardContent>
          </Card>
