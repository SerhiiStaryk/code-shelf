...
const TSTips: React.FC = () => {
  ...
  const filteredTips = activeTab === 0 
    ? tips 
    : tips.filter(tip => tip.category === categories[activeTab].name)
    ...
    <Box>
      ...
      <Alert severity="info" sx={{ mb: 4 }}>
        <Typography variant="body2">
          These TypeScript tips cover everything from basic type definitions to advanced patterns. 
          Each tip includes practical code examples you can use in your projects.
        </Typography>
      </Alert>
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: 3 }}>
          <Card>
            <CardContent>
              ...
              <List dense>
                <ListItem>
                  <ListItemText primary="TypeScript Compiler" secondary="Official TypeScript compiler" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="ESLint TypeScript" secondary="TypeScript-aware linting" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="Prettier" secondary="Code formatting with TypeScript support" />
                </ListItem>
              </List>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent>
              ...
              <List dense>
                <ListItem>
                  <ListItemText primary="TypeScript Playground" secondary="Online TypeScript editor" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="TypeScript Handbook" secondary="Official documentation" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="TypeScript Examples" secondary="Community examples and patterns" />
                </ListItem>
              </List>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent>
              ...
              <List dense>
                <ListItem>
                  <ListItemText primary="Zod" secondary="TypeScript-first schema validation" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="io-ts" secondary="Runtime type validation" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="TypeScript ESLint" secondary="TypeScript-specific linting rules" />
                </ListItem>
              </List>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent>
              ...
              <List dense>
                <ListItem>
                  <ListItemText primary="TypeScript Deep Dive" secondary="Comprehensive guide" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="TypeScript Weekly" secondary="Weekly newsletter" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="TypeScript Community" secondary="Discord and forums" />
                </ListItem>
              </List>
            </CardContent>
          </Card>
