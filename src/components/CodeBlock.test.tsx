...
vi.mock('react-syntax-highlighter', () => ({
  Prism: ({ children, language, showLineNumbers }: any) => (
    <pre data-testid="syntax-highlighter" data-language={language} data-show-line-numbers={showLineNumbers}>
      {children}
    </pre>
  ),
}))
...
describe('CodeBlock', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders title when provided', () => {
      render(<CodeBlock {...defaultProps} title="Test Code Block" />)
      
      expect(screen.getByText('Test Code Block')).toBeInTheDocument()
    })

    it('renders description when provided', () => {
      render(<CodeBlock {...defaultProps} description="This is a test description" />)
  ...
  describe('Edge cases', () => {
    ...
    it('handles HTML entities in code', () => {
      ...
      render(<CodeBlock code={htmlCode} language="html" />)
  ...
  describe('Styling and layout', () => {
    ...
    it('renders with proper spacing', () => {
      render(<CodeBlock {...defaultProps} title="Test" description="Description" />)
